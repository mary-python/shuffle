...
def runDftVaryM():
    ...
    for m in mset:
        ...
        runDft(2, m, mset, mconst, tconst, kconst, m, epsconst, nconst, heartbeatDataConstDConstN, totalVectorConstDConstN, 0.1, 1, perErrors, recErrors, totalDftErrors, totalDftStandardDeviation, loopTotal)
