...
def runDftVaryEps():
    ...
    for eps in epsset:
        ...
        runDft(4, eps, epsset, epsconst, tconst, kconst, mconst, dconst, eps, nconst, heartbeatDataConstDConstN, totalVectorConstDConstN, 4, 2, perErrors, recErrors, totalDftErrors, totalDftStandardDeviation, loopTotal)
